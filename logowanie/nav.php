...
<body>
  <div class="flex-nav">
    ...
    <div class="flex-nav-center">
      <div class="flex-nav-icon">Home</div>
      <div class="flex-nav-icon">Menu</div>
      <div class="flex-nav-icon">Service</div>
      <div class="flex-nav-icon">Contact</div>
    </div>

    <div class="flex-nav-right">
    <div class="flex-nav-icon flex-nav-user-icon"><i class="fas fa-user fa-lg"></i></div>
      <div class="flex-nav-icon flex-nav-cart-icon"><i class="fas fa-shopping-cart fa-lg"></i></div>
